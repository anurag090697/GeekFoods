    ...
    <section className='dataShow'>
      <div className='dataTop'>
        ...
        <div className='dataInfo'>
          ...
          <button className='btnKM'>Get in Touch</button>
        </div>
      </div>
      <div className='profGrids'>
        <div>
          <div className='profilePara'>
            <p>
              ...
              corrupti blanditiis dolorum! Officia assumenda rem nam, eveniet
              enim ad inventore laudantium est illum voluptatem quis.
            </p>
          </div>
          <div className='dpinfo'>
            <img
              src='https://github.com/anurag090697/GeekFoods/blob/main/public/assets/Zeno-Profile-Pic.png?raw=true'
              alt=''
            />
            <div>
              {" "}
